...
class BlogController extends Controller
{
    ...
    {
        // Pass any additional data (if needed) to the create-blog view
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('home')->with([
            ...
            'blog' => $blog, // Pass the created blog to the view
        ]);
    }
    ...
    public function index()
    {
        ...
        return view('home.blog', [
            'blogs' => $blogs,
            'total_blogs' => $blogs->count(), // Pass additional data intelligently
        ]);
    }
}
